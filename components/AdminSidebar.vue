...
const auth = useAuth()
const { canAccessAdminPath } = useAdminPermissions()
...
const allNavItems = [
  ...
  },
  {
    to: '/admin/landing',
    label: 'Landing page',
    icon: `<svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><rect x="3" y="3" width="18" height="18" rx="2"/><path d="M3 9h18M9 21V9"/></svg>`,
  },
  {
  ...
  },
  {
    to: '/admin/programme',
    label: 'Programme',
    icon: `<svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><rect x="3" y="4" width="18" height="18" rx="2"/><path d="M16 2v4M8 2v4M3 10h18"/></svg>`,
  },
  {
    to: '/admin/ateliers',
    label: 'Ateliers',
  ...
  },
  {
    ...
    label: 'Comptabilité',
    icon: `<svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M12 2v20M17 5H9.5a3.5 3.5 0 0 0 0 7h5a3.5 3.5 0 0 1 0 7H6"/></svg>`,
  },
  {
    to: '/admin/documents',
    label: 'Documents',
  ...
  },
  {
    to: '/admin/donnees',
    label: 'Données',
    icon: `<svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><ellipse cx="12" cy="5" rx="9" ry="3"/><path d="M3 5v6c0 1.7 4 3 9 3s9-1.3 9-3V5"/><path d="M3 11v6c0 1.7 4 3 9 3s9-1.3 9-3v-6"/></svg>`,
  },
]

const navItems = computed(() =>
  allNavItems.filter((item) => canAccessAdminPath(item.to)),
)
